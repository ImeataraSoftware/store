      ...
      <div>
        ...
        <div className="h-fit mt-16" style={{ height: "calc(100vh - 64px)" }}>
          ...
          <section className="flex w-full h-full ">
            <img
              className="w-0 flex-grow object-cover opacity-80 transition ease-out duration-500 hover:cursor-crosshair hover:w-80 hover:opacity-100 hover:filter-contrast-120"
            ...
            />
            <img
              className="w-0 flex-grow object-cover opacity-80 transition duration-500 hover:cursor-crosshair hover:w-80 hover:opacity-100 hover:filter-contrast-120"
